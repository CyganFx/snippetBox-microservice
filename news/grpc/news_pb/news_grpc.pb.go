...
func (c *newsServiceClient) GetNews(ctx context.Context, in *NewsGetRequest, opts ...grpc.CallOption) (*NewsGetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.NewsService/GetNews", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *newsServiceClient) CreateNews(ctx context.Context, in *NewsCreateRequest, opts ...grpc.CallOption) (*NewsCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.NewsService/CreateNews", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NewsService_GetNews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.NewsService/GetNews",
	}
...
func _NewsService_CreateNews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.NewsService/CreateNews",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var NewsService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc/news_pb/news.proto",
}
