...
func Login(c *gin.Context) {
	...
	if err == nil {
		...
		if Password != decrypted {
			...
			c.JSON(200, gin.H{"data": "*your password is incorrect"})
		...
		c.JSON(200, gin.H{"data": "*you are not registered"})
...
func Register(c *gin.Context) {
	...
	var count int
	_ = db.QueryRow("SELECT COUNT(*) FROM tbl_user WHERE email_id= ?", email).Scan(&count)
	if count != 1 {
		...
		c.JSON(200, gin.H{"data": "*Already used this Email id "})
	}
